...
If you are running Ruby script(s) that do not have or require a Gemfile, you can just get rid of all code in Dockfile that has anything to do with Gemfiles.
